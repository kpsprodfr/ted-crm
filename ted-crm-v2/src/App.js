...
<div class="header"><div style="display:flex;align-items:center;justify-content:center;gap:12px;margin-bottom:8px"><img src="https://ted-crm.pages.dev/favicon.png" style="height:48px;width:48px" /><div class="logo">LE TED</div></div><div class="subtitle">Restaurant &amp; Club — Chassieu</div><div class="date-title">${dateFormatee}</div><div class="service-badge">${serviceLabel2}</div></div>
...
<tbody>${lignes}${(() => { const n = resasConfirmees.length; const nb = n % 4 === 0 ? 4 : 4 - (n % 4); return Array(nb).fill('<tr><td>&nbsp;</td><td></td><td></td><td></td><td></td><td></td></tr>').join(''); })()}</tbody></table>
